...
$user=array(
    'USER_LOGIN'=>'psvet@team.amocrm.com', #Ваш логин (электронная почта)
    'USER_HASH'=>'3773f2f553ab70d5bdf73e0020a77452cc152c17' #Хэш для доступа к API (смотрите в профиле пользователя)
);
